        ...
        <div class="project-form">
            <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" class="input-item title" placeholder="Project Title" name="title" value="{{ old('title', $project->title) }}">
                ...
                <div class="form-group">
                    <input type="text" class="input-item link" placeholder="Project Demo Link" name="project_link" value="{{ old('project_link', $project->project_link) }}">
                    <span class="focus-border"></span>
                    @error('project_link')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    <input type="text" class="input-item coder" placeholder="Project Coder" name="coder" value="{{ old('coder', $project->coder) }}">
                    <span class="focus-border"></span>
                    @error('coder')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    <textarea spellcheck="false" placeholder="Project Overview..." class="input-item overview" id="overview" required name="overview">
