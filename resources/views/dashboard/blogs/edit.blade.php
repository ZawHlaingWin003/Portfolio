        ...
        <div class="blog-form">
            <form action="{{ route('blogs.update', $blog) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-group">
                    <input type="text" class="input-item title" placeholder="Blog Title" name="title" value="{{ old('title', $blog->title) }}" id="title">
                ...
                <div class="form-group">
                    <input type="text" class="input-item slug" placeholder="Blog Slug" name="slug" id="slug" value="{{ old('slug', $blog->slug) }}">
                    <span class="focus-border"></span>
                    @error('slug')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    <textarea spellcheck="false" placeholder="Blog Excerpt" class="input-item excerpt" required name="excerpt" id="excerpt">{{ old('excerpt', $blog->excerpt) }}</textarea>
                    <span class="focus-border"></span>
                    @error('excerpt')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    <textarea name="content" class="content" id="content">{{ old('content', $blog->content) }}</textarea>
                    @error('content')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                </div>
