    ...
    <div class="container">
        ...
        <div class="project-form">
            <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <textarea spellcheck="false" placeholder="Project Overview..." class="input-item overview" id="overview" required
                        name="overview">{{ old('overview', $project->overview) }}</textarea>
                    <span class="focus-border"></span>
                    @error('overview')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    <input type="file" name="image_path" id="file-1" class="inputfile inputfile-1"
                    ...
                    <div class="old-img">
                        ...
                        <img src="{{ asset('frontend/images/projects/' . $project->image_path) }}" alt="Image Preview"
                            width="300px" />
                    </div>
                </div>
