        ...
        <div class="project-form">
            <form action="{{ route('projects.update', $project->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                    <input class="input-item title" name="title" placeholder="Project Title" type="text" value="{{ old('title', $project->title) }}">
                ...
                <div class="form-group">
                    <input class="input-item link" name="project_link" placeholder="Project Demo Link" type="text"
                ...
                <div class="form-group">
                    <input class="input-item coder" name="coder" placeholder="Project Coder" type="text" value="{{ old('coder', $project->coder) }}">
                    <span class="focus-border"></span>
                    @error('coder')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    <textarea class="input-item overview" id="overview" name="overview" placeholder="Project Overview..." required spellcheck="false">{{ old('overview', $project->overview) }}</textarea>
                    <span class="focus-border"></span>
                    @error('overview')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input class="skillTags" id="skillTags" name="skills" type="text">
                    <span class="focus-border"></span>
                    @error('skills')
                        <small><span class="text-danger error">* {{ $message }}</span></small>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="old-img">
                        ...
                        <img alt="Image Preview" src="{{ $project->image }}" width="300px" />
                    </div>
                </div>
                <button class="main-btn" type="submit">Update Project <i class="fa fa-edit"></i></button>
            </form>
        </div>
    </div>
@endsection
